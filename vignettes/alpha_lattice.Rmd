...
## 1. Generate a Alpha Lattice Design in FielDHub App

To generate an alpha lattice design using the FielDHub app:

First, go to **Lattice Designs** > **Alpha Lattice**
...
## 2. Generate the design by the `alpha_lattice()` function
