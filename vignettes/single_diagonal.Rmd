...
## Inputs
First, make sure **Import entries' list** has "No" selected, as we are entering our own information about the entries. 
...
### Field Book
The **Field Book** displays all the information on the experimental design in a table format. It contains the specific plot number and the row and column address of each entry, as well as the corresponding treatment on that plot. This table is searchable, and we can filter the results in every column. 
...
```{r, results='hide'}
diag_expt <- diagonal_arrangement(nrows = 11,
                     ncols = 40,
                     lines = 400,
                     checks = 6,
                     l = 1,
...
```{r, comment='', echo=FALSE}
print(head(diag_expt$fieldBook))
```
