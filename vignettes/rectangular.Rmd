...
Then, we input the number of treatments in the **Input # of Treatments** box. In a rectangular lattice design, the number of treatments must be a _rectangular number_, the product of two consecutive numbers (integers, in particular). For example, 7 x 8 = 56 is a valid entry, which we will use in this example. The number of replications of these treatments is selected with the **Input # of Full Reps**. The next box, **Input # of Plots per IBlock**, sets the number of plots in each incomplete block.
