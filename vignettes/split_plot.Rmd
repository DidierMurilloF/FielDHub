...
9. To ensure that randomizations are consistent across sessions, we can set a seed number in the box labeled **Seed Number**. In this example, we will set it to `1237`. 
...
*   `wp = 24` is the number of whole-plots.
*   `sp = 4` is the number of sub-plots.
...
*   `seed = 1240` is the seed number to replicate identical randomizations.
