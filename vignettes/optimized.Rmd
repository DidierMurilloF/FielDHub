...
In this design you can set the number of entries and the number of checks for the experiment. You can also choose to run the same experiment over multiple locations. 


## Generate a Single Diagonal Arrangement in FielDHub app

In this vignette, we will show an example of an optimized arrangement design experiment over 3 locations with 3 checks of 12, 10, and 8 reps each, and 405 entries. We will distribute the total 435 plots over a 29 x 15 field.  
...
*   `amountChecks = c(12,10,8)` are the values for representing 
