...
vignette: >
  %\VignetteIndexEntry{full_factorial}
...
## Inputs
First, select "No" in the **Import entries' list** box, as we are entering our own information about the experiment. We can choose whether to use the factorial design in a RCBD or CRD with the **Select a Factorial Design Type** box.
Then, we set the number of entries for each factor in a comma separated list in the **Input # of Entries for Each Factor** box. If we want our example experiment to have 3 factors with 2, 3, and 4 entries respectively, we would enter 2,3,4.  The number of replications of the squares is set with the **Input # of Full Reps** box. 
...
library(knitr)
library(FielDHub)
factorial <- full_factorial(setfactors = c(2,3,4),reps = 3,l = 1,type = 2,seed = 123)
