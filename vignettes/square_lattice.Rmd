...
This vignette shows how to generate a **square lattice design** using both the FielDHub Shiny App and the scripting function `square_lattice()` from the `FielDHub` package.
