...
This vignette shows how to generate an **unreplicated optimized arrangement design** using both the FielDHub Shiny App and the scripting function `optimized_arrangement()` from the `FielDHub` package.
...
You can run the same design with the function `optimized_arrangement()` in the F`ielDHub` package.
