...
9. To ensure that randomizations are consistent across sessions, we can set a seed number in the box labeled **Seed Number**. In this example, we will set it to `1244`. 
...
*   `seed = 1244` is the seed number to replicate identical randomizations.
