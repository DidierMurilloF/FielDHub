...
Then, we input the number of treatments in the **Input # of Treatments** box. The number of treatments must be a square in the square lattice design. The number of replications of these treatments is selected with the **Input # of Full Reps**. The next box, **Input # of Plots per IBlock**, sets the number of plots in each incomplete block.
...
```
```{r, results='hide'}
square <- square_lattice(t = 64,     #number of treatments, must be square number
                         k = 8,      #number of plots per incomplete block
