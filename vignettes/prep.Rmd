...
In this design you can set the number of entries with reps. You can also choose to run the same experiment over multiple locations. 

## Generate a Partially Replicated Design in FielDHub App
