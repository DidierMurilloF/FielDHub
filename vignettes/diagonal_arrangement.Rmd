...
One of the kinds of unreplicated designs you can use in FielDHub is single diagonal arrangement. In this design you can set the number of entries and the number of checks for the experiment. You can also choose to run the same experiment over multiple locations. 
