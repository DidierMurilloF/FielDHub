...
6. To ensure that randomizations are consistent across sessions, we can set a seed number in the box labeled **Seed Number**. For instance, we will set it to `16`. 
...
In the **Choose % of Checks:** dropdown box users can play with different options for the total amount of checks in the field. 
