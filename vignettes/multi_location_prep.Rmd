...
to optimize the allocation of replicated and unreplicated treatments across the environments.
...
The optimization problem that we try to solve is the following: Given a matrix $X$ of integers 
(p-rep design within location), we want to ensure that the distance between any two occurrences 
