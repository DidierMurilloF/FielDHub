...
Set `allow_fillers = TRUE` to consider field dimensions with a small number of
filler plots when a location has no suitable exact dimensions. The default is
`FALSE`, and the genotype allocation across locations is unchanged when fillers
are enabled.
