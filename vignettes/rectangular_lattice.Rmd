...
3. Select the number of replications of these treatments with the **Input # of Full Reps** box, which is `3`.

4. Set the number of plots in each incomplete block in the **Input # of Plots per IBlock** box, which is `7`.
...
9. To ensure that randomizations are consistent across sessions, we can set a seed number in the box labeled **Seed Number**. In this example, we will set it to `1235`. 
...
*   `seed = 1235` is the seed number to replicate identical randomizations.
