...
# Randomized Complete Block Design in FielDHub App
...
7. Enter a name for the location of the experiment in the **Input Location** box. If there are multiple locations, each name must be in a comma separated list. 
...
rcbd <- RCBD(t = 16,     # number of treatments
             ...
             locationNames = "FARGO" #optional location name
)
```
