...
With `spread_checks = TRUE` (the default), the repeated copies of each check are placed one per contiguous stratum of the block, which keeps the copies of a check apart within the block rather than letting them land next to each other by chance.