...
For example, we say a project needs to test 120 genotypes of cassava over two locations. In addition, the research  include four checks and six augmented blocks to carry out this experiment. This design setup comes out with 6 blocks of size 24 plots for a total of 144 plots that will be distributed in a field of 12 rows and 12 columns.
...
*   `exptName = "Cassava_2022"` is an optional name for experiment.
