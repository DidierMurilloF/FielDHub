...
We would like to acknowledge Mr. [Jean-Marc Montpetit](https://www.linkedin.com/in/jean-marc-montpetit/)
for contributing code and ideas for the `swap_pairs()` and `pairs_distance()` functions. His contributions have had a 
