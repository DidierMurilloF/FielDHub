...
If the number of experimental plots does not have suitable field dimensions,
filler plots can be enabled explicitly. The selected field dimensions determine
the number of fillers. Fillers are placed at the end of the planter path, so a
Cartesian layout ends on the right, while a serpentine layout ends on the left
for an even number of rows and on the right for an odd number of rows.
