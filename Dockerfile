...
RUN Rscript -e 'remotes::install_version("desplot",upgrade="never", version = "1.8")'
...
RUN Rscript -e 'remotes::install_version("blocksdesign",upgrade="never", version = "4.9")'
RUN Rscript -e 'remotes::install_version("numbers",upgrade="never", version = "0.8-2")'
RUN Rscript -e 'remotes::install_version("shinyjqui",upgrade="never", version = "0.4.0")'
RUN Rscript -e 'remotes::install_version("turner",upgrade="never", version = "0.1.7")'
...
EXPOSE 80
CMD R -e "options('shiny.port'=80,shiny.host='0.0.0.0');FielDHub::run_app()"
