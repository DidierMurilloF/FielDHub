...
First of all, thanks for considering contributing to FielDHub! 👍 It’s
people like you that make it rewarding for us - the project
maintainers - to work on FielDHub. 😊
...
Conduct](https://didiermurillof.github.io/FielDHub/dev/CODE_OF_CONDUCT.md).
...
Think FielDHub is useful? Let others discover it, by telling them in
person, via Twitter or a blog post.

Using FielDHub for a paper you are writing? Consider [citing
it](https://DidierMurilloF.github.io/FielDHub/authors.html).

### Ask a question ⁉️

Using FielDHub and got stuck? Browse the
[documentation](https://DidierMurilloF.github.io/FielDHub) to see if you
can find a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/DidierMurilloF/FielDHub/issues/new). While we
...
Have an idea for a new FielDHub feature? Take a look at the
[documentation](https://DidierMurilloF.github.io/FielDHub) and [issue
list](https://github.com/DidierMurilloF/FielDHub/issues) to see if it
isn’t included or suggested yet. If not, suggest your idea as an [issue
on GitHub](https://github.com/DidierMurilloF/FielDHub/issues/new). While
...
Using FielDHub and discovered a bug? That’s annoying! Don’t let others
have the same experience and report it as an [issue on
GitHub](https://github.com/DidierMurilloF/FielDHub/issues/new) so we can
...
[This website](https://DidierMurilloF.github.io/FielDHub) is generated
with [`pkgdown`](http://pkgdown.r-lib.org/). That means we don’t have to
...
issue](https://github.com/DidierMurilloF/FielDHub/issues/new) and we can
...
Care to fix bugs or implement new functionality for FielDHub? Awesome!
👏 Have a look at the [issue
list](https://github.com/DidierMurilloF/FielDHub/issues) and leave a
...
1.  Fork [this repo](https://github.com/DidierMurilloF/FielDHub) and
...
This Contributing is adapted from
[CONTRIBUTING](https://gist.github.com/peterdesmet/e90a1b0dc17af6c12daf6e8b2f044e7c).
